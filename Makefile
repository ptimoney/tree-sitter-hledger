LANGUAGE_NAME := tree-sitter-hledger
HOMEPAGE_URL := https://github.com/ptimoney/tree-sitter-hledger
VERSION := 0.0.1
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/hledger '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/hledger
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/hledger
